    ...
    return (
        ...
        <svg width="120" height="120" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            <g transform="translate(24 20)">
                <circle cx="10" cy="10" r="8" stroke="#FFFFFF" stroke-width="3"/>
                <rect x="28" y="7" width="40" height="6" rx="3" fill="#FFFFFF"/>

                <circle cx="10" cy="40" r="8" stroke="#FFFFFF" stroke-width="3"/>
                <rect x="28" y="37" width="40" height="6" rx="3" fill="#FFFFFF"/>

                <circle cx="10" cy="70" r="8" stroke="#FFFFFF" stroke-width="3"/>
